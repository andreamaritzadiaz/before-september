...
function getCanvasLayout() {
    ...
    elements.forEach(el => {
        ...
        switch (type) {
            case 'image':
            case 'video':
                const mediaSrc = el.querySelector('img, video')?.src || '';
                if (mediaSrc.startsWith('data:')) {
                    base.src = el.dataset.filename || mediaSrc;
                } else {
                    base.src = mediaSrc;
                }
            ...
            case 'sticker':
                ...
                break;
            case 'audio':
                const audioSrc = el.querySelector('audio')?.src || '';
                if (audioSrc.startsWith('data:')) {
                    base.src = el.dataset.filename || audioSrc;
                } else {
                    base.src = audioSrc;
                }
