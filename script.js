const bucketList = [
    ...
    },
    {
        ...
        scrapbook: [
            ...
            { type: 'image', x: 580, y: 1530, rotation: 0.01, src: 'images/valeriasmoney.JPG', width: 238 },
...
function openAbout() {
    ...
    const totalWidth = 280 + 50 + 380; // gif + gap + letter
...
function renderScrapbookMobile(scrapbookData) {
    ...
    sortedImages.forEach(({ data, origIdx }, sortedIdx) => {
        ...
        // A plain <img> rather than a scrapbook element: .sb-element is forced
        // back into the mobile flow (position/transform: none !important), so an
        // overlay built that way would be flattened like everything else.
        const over = overlayFor.get(data.src);
        if (over) {
            const overImg = document.createElement('img');
            overImg.className = 'sb-mobile-overlay-img';
            overImg.src = over.src;
            overImg.draggable = false;
...
const DOT_PATTERN = [[0.233,0.032],[0.267,0.032],[0.233,0.042],[0.25,0.042],[0.25,0.074],[0.283,0.053],[0.383,0.053],[0.4,0.042],[0.417,0.042],[0.083,0.084],[0.1,0.095],[0.133,0.105],[0.183,0.116],[0.3,0.105],[0.3,0.116],[0.35,0.084],[0.4,0.084],[0.1,0.126],[0.133,0.158],[0.233,0.126],[0.267,0.137],[0.383,0.137],[0.383,0.158],[0.15,0.189],[0.167,0.2],[0.4,0.179],[0.45,0.189],[0.5,0.2],[0.117,0.232],[0.133,0.221],[0.467,0.242],[0.5,0.242],[0.533,0.232],[0.567,0.221],[0.017,0.284],[0.033,0.284],[0.083,0.253],[0.133,0.284],[0.183,0.284],[0.2,0.284],[0.35,0.274],[0.367,0.263],[0.417,0.253],[0.05,0.295],[0.233,0.305],[0.25,0.326],[0.333,0.316],[0.05,0.347],[0.067,0.358],[0.067,0.368],[0.1,0.358],[0.217,0.358],[0.267,0.337],[0.283,0.368],[0.317,0.368],[0.583,0.368],[0.767,0.368],[0.8,0.368],[0.083,0.379],[0.2,0.389],[0.2,0.411],[0.233,0.389],[0.233,0.411],[0.3,0.379],[0.317,0.379],[0.533,0.4],[0.55,0.4],[0.567,0.4],[0.583,0.4],[0.6,0.4],[0.767,0.389],[0.783,0.389],[0.783,0.411],[0.8,0.4],[0.817,0.4],[0.833,0.389],[0.833,0.411],[0.867,0.4],[0.867,0.411],[0.9,0.4],[0.9,0.411],[0.933,0.389],[0.95,0.389],[0.183,0.421],[0.167,0.453],[0.2,0.432],[0.217,0.432],[0.217,0.453],[0.233,0.442],[0.233,0.453],[0.267,0.432],[0.283,0.453],[0.333,0.442],[0.367,0.442],[0.383,0.453],[0.417,0.442],[0.433,0.432],[0.567,0.421],[0.683,0.421],[0.7,0.432],[0.717,0.432],[0.733,0.432],[0.75,0.432],[0.75,0.453],[0.767,0.442],[0.783,0.442],[0.8,0.421],[0.817,0.421],[0.8,0.453],[0.833,0.432],[0.85,0.432],[0.85,0.453],[